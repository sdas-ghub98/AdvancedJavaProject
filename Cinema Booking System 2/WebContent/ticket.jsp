...
<%
	...
	String method_pay = request.getParameter("payment");
		...
		<div class="panel-body">
			...
			<div class="input-fields">
				...
				<div class="column-2">
					...
					<h4>Payment Method : <%=method_pay %></h4>
				</div>
			</div>
		</div>

		<div class="panel-footer">
			<a href="payment.jsp"><button id=prev class="btn back-btn">Back</button></a>
			<a href="Pay"><button class="btn next-btn">Pay</button></a>
		</div>
	</div>
